...
const SpaceX = () => {
  ...
  >
    ...
    <g className="letter_e">
      <polygon fill="#ffffff" points="228.3,43.5 228.3,34.1 247,34.1 247,28.9 218.9,28.9 218.9,49.3 260.4,49.3 260.4,43.5" />
      <rect fill="#ffffff" x="219.9" y="18.6" width="41.9" height="5.4" />
    </g>
